...
def main():
    ...
    if n_rows > 0:
        ...
        fig.suptitle("256x256 latents: latent arithmetic (left→right)", fontsize=12)
        ...
        out_grid = os.path.join(OUT_DIR, "latent_arith_grid_latent256.png")
    ...
    ax.set_title("t-SNE of latents (256x256) with LR / AB arrows", fontsize=10)
    ax.legend(fontsize=8, loc="best")
    plt.tight_layout()
    out_tsne = os.path.join(OUT_DIR, "latent_arith_tsne_latent256.png")
